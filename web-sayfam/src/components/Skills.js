...
export default function Skills() {
  return (
    <div className="flex justify-content-space-between flex-direction-column-max-width-1060px">
      ...
      <div className="flex flex-direction-column  gap-2-1875-rem flex-direction-row-max-width-1060px justify-content-space-between-max-width-1060">
        <div className="flex align-items-center gap-1-66vw width-21-84vw">
          <img src={js} alt="js" className="logo width-206vw"></img>
          <p className="logo-yazi">JAVASCRIPT</p>
        </div>
        <div className="flex align-items-center gap-1-66vw width-21-84vw">
          <img src={react} alt="react" className="logo width-206vw"></img>
          <p className="logo-yazi">REACT</p>
        </div>
        <div className="flex align-items-center gap-1-66vw width-21-84vw">
          <img src={redux} alt="redux" className="logo width-206vw"></img>
          <p className="logo-yazi">REDUX</p>
        </div>
      </div>
      <div className="flex flex-direction-column  gap-2-1875-rem  flex-direction-row-max-width-1060px justify-content-space-between-max-width-1060">
        <div className="flex align-items-center gap-1-66vw width-21-84vw">
          <img src={node} alt="node" className="logo width-206vw"></img>
          <p className="logo-yazi">NODE</p>
        </div>

        <div className="flex align-items-center gap-1-66vw width-21-84vw">
          <img src={vscode} alt="vscode" className="logo width-206vw"></img>
          <p className="logo-yazi">VS CODE</p>
        </div>

        <div className="flex align-items-center gap-1-66vw width-21-84vw ">
          <img src={figma} alt="figma" className="logo width-206vw"></img>
